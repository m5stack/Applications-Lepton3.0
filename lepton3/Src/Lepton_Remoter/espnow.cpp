...
void Espnow::OnRemotRecv(const uint8_t *mac_addr, const uint8_t *data, int data_len){
...
void Espnow::OnBotRecv(const uint8_t *mac_addr, const uint8_t *data, int data_len)
{
